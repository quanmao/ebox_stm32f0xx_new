...
// 配置内存池大小
#define cfgTOTAL_HEAP_SIZE1		( ( size_t ) ( 1*128 ) )//内部内存池大小
...
//#define cfgASSERT( x )   ((x) ? (void)0U : assert_failed((uint8_t *)__FILE__, __LINE__))
#define cfgASSERT( x ) ((void)0U)
